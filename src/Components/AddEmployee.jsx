...
const AddEmployee = (props) => {
	const [Employee, setEmployee] = useState({name : "", gender: "", age : "" , designation: "" , department : "", date: ""})
  return (
    <>
     {/* Add Employee Modal  */}
					...
					<form>
						<div className="form-row ">
							<div className="form-group col-md-6">
								...
								<input type="text" className="form-control" id="" placeholder="Enter" value={Employee.name}
